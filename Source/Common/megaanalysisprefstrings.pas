...
const         // suffix 1 means level 1 and 2 means level 2
  ...
  opsTestPhylo1         = 'Phylogeny Test';
    ...
    opsBootstrapSubSamples   = 'No. of Bootstrap Sub-samples';
    opsBootstrapRepsPerSample = 'No. of Replicates per Sub-sample';
    opsBootstrapSitesPerSample = 'Max No. of Sites per Sub-sample';
    opsBootstrapSampleSizeFactor = 'Sample Size Factor';
    opsBootReps2        = 'No. of Bootstrap Replications';
  ...
  opsDataSubset1             = 'Data Subset to Use';
    opsGapMissingHandle2     = 'Gaps/Missing Data Treatment';
  ...
  // Branch length filter (used during searching of ML trees)
    opsBLensFilter2          = 'Branch Swap Filter';
...
const
  ...
  //UserTreeStr       = 'User specified tree';
  ...
  LittleBootTestStr = 'Little Bootstraps method';
...
//                          '"'+Model_Allele_Freq_Dist +'"'
  ...
  InitialTreeByDefaultStr = 'Make initial tree automatically (Default - NJ/BioNJ)';
  ...
  LocalClockStr = 'Local clocks';
  RRFrameworkStr = 'Relative Rate Framework';

  NoBlenFilterStr = 'None';
  ...
  BLensFilterPickList = '"' + NoBlenFilterStr + '",' +
                        '"' + VeryStrongStr + '",' +
                        '"' + StrongStr     + '",' +
                        '"' + ModerateStr   + '",' +
                        '"' + WeakStr       + '",' +
