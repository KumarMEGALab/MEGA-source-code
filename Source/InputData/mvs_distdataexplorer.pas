...
begin
  ...
  {$IFDEF VISUAL_BUILD}
  {$IFNDEF CALTEST}
  VS_DistDataExplorer.DispSelTaxaItem := V_DistDataExplorer.DispSelTaxaItem.Checked;
  VS_DistDataExplorer.DispShowGpNames := V_DistDataExplorer.DispGpNamesItem.Checked;
  VS_DistDataExplorer.CurFont := V_DistDataExplorer.DataGrid.Font;
  {$ENDIF}
  {$ENDIF}
end;
