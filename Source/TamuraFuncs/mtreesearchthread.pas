...
type
  ...
  protected
    ...
    procedure clearDistCalcPerc; virtual;
    procedure DistCalcFinishedProc; virtual;
    procedure clearTreeSearchPerc; virtual;
    procedure TreeSearchFinishedProc; virtual;
  public
...
//    property TreeMakingProc: TTreeMakingProc read FTreeMakingProc write FTreeMakingProc;
  ...
  private
    ...
    procedure AddBootTree(Tree: TTreeData);
...
uses
  ...
  Mega_Main,
  {$ENDIF}
  MegaUtils, MGlobalSettings, MAnalysisInfo, mmemutils,
...
begin
  ...
  if SecondsBetween(StartTime, Now) <= 5 then Exit; { highly inaccurate until a small amount of time has passed}
  s  := Trunc(SecondsBetween(StartTime,Now)/AProgress*(100-AProgress))+1;
  h  := s div 3600;
  m  := (s div 60) -h*60;
  s  := s mod 60;
