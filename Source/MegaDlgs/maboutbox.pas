...
begin
  ...
  CopyrightLabel.Caption := '1993-' + IntToStr(Year);
...
const
  ...
  MR_DEVELOPER = 1001;
  MR_PROTOTYPER = 1002;
  MR_DEVELOPER_PROTOTYPER = 1003;
var
  CustomRes: Integer;
begin
  if authenticate then
  begin
    CustomRes := QuestionDlg('Pick a Mode', 'Which mode would you like?:', mtCustom, [MR_RELEASE, 'Release', MR_DEVELOPER, 'Developer', MR_PROTOTYPER, 'Prototyper', MR_DEVELOPER_PROTOTYPER, 'Developer and Prototyper'], 0);
    case customRes of
      MR_RELEASE:
      begin
        isDeveloper := false;
    ...
    MegaForm.ApplyPrototyperVisualModifications;
