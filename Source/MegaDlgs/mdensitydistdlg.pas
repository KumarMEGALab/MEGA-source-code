...
uses
  ...
  Dialogs, ComCtrls, ExtCtrls, StdCtrls, Spin, ActnList, IniPropStorage,
  MegaConsts, mcalibrationdensity, MCalibrationData, mimageform, MegaUtils,
  MegaPrivateFiles;
...
uses
  math, StringUtils, spe, MegaVerConsts;

{ TCalibrationParamsDlg }

procedure TCalibrationParamsDlg.OkBtnMouseEnter(Sender: TObject);
begin
...
procedure TCalibrationParamsDlg.CancelBtnMouseEnter(Sender: TObject);
begin
  ButtonImages.GetBitmap(3, CancelBtn.Picture.Bitmap);
end;

procedure TCalibrationParamsDlg.CancelBtnMouseLeave(Sender: TObject);
begin
...
procedure TCalibrationParamsDlg.OkBtnMouseLeave(Sender: TObject);
begin
