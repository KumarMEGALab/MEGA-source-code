...
procedure TJumpToGeneDupForm.CloseBtnMouseEnter(Sender: TObject);
begin
  ButtonImages.GetBitmap(1, CloseBtn.Picture.Bitmap);
end;

procedure TJumpToGeneDupForm.CloseBtnMouseLeave(Sender: TObject);
begin
  ButtonImages.GetBitmap(0, CloseBtn.Picture.Bitmap);
end;
