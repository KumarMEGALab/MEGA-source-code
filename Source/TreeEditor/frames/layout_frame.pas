...
type
  ...
  TLayoutFrame = class(TFrame, ITreeToolbarFrame)
    ...
    Panel1: TPanel;
    Panel2: TPanel;
    RootOnMidpointBtn: TSpeedButton;
    RootOnOutgroupBtn: TSpeedButton;
    TreeStyleBtn: TSpeedButton;
    TopologyOnlyBtn: TSpeedButton;
    AutoSizeBtn: TSpeedButton;
    DragResizeBtn: TSpeedButton;
    TreeWidthTrackBar: TTrackBar;
    TreeHeightTrackBar: TTrackBar;
