...
begin
  ...
  {$IFDEF DARWIN}
  rightEdgeOfLabel := Label1.Left + Label1.Width;
  if CondensedSEdit.Left < (rightEdgeOfLabel + 10) then
  begin
    CondensedSEdit.Left := rightEdgeOfLabel + 10;
    ConsensusSEdit.Left := CondensedSEdit.Left;
    Label3.Left := ConsensusSEdit.Left + ConsensusSEdit.Width + 10;
