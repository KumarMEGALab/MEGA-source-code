...
type
  ...
  public
    ...
    procedure UpdateSpeedButton(aSpeedBtn: TSpeedButton);    
    ...
    function ScaleButtonImage(aSize: Integer): Integer;
  end;
...
procedure TImageForm.UpdateSpeedButton(aSpeedBtn: TSpeedButton);
begin
  aSpeedBtn.ImageWidth := ScaleButtonImage(18);
end;
...
function TImageForm.ScaleButtonImage(aSize: Integer): Integer;
begin
  Result := Round(aSize * PixelsPerInch/DesignTimePPI);
end;
