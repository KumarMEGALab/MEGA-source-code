...
procedure TV_DistDataExplorer.DoSaveSession(data: PtrInt);
var
...
procedure TV_DistDataExplorer.IniPropStorage1RestoreProperties(Sender: TObject);
begin
  {$IFDEF DARWIN}
...
procedure TV_DistDataExplorer.IniPropStorage1SavingProperties(Sender: TObject);
begin
  {$IFDEF DARWIN}
...
procedure TV_DistDataExplorer.MenuItem17Click(Sender: TObject);
begin
  OpenUrl(MegaGptUrl);
end;
