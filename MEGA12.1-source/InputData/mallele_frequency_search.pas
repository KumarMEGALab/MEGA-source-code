...
begin
  try
    ...
    {$IFDEF DEBUG}
      {$IFNDEF VISUAL_BUILD}
      aList := D_InputSeqData.GetAlleleFrequenciesAsStringList(0.0, 1.0, FFirstSeqIsReference, FIncludeReferenceSequence);
      aList.SaveToFile(NextAvailableFilenameNV('_all_allele_freqs.txt'));
      aList.Free;
      {$ENDIF}
    {$ENDIF}
