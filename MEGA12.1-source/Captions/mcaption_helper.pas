...
begin
  try
    try
      ...
      {$IFDEF VISUAL_BUILD}
      if FTree.isAncState or (MAI.MyUsrOperation in [dtdoMLInferAncSeq, dtdoMLInferAncSeqMyPeg, dtdoMPInferAncSeq, dtdoMPInferAncSeqMyPeg, dtdoMPPredictLivingSeq]) then
