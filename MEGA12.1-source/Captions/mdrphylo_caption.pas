...
uses
  MegaConsts, MLegendGenerator, MegaVerConsts, mega_citation;
...
var
  ...
  megaCitation: String = '';
begin
  megaCitation := MapMajorVersionToCitation(MAJOR_VERSION);
  FStrBuilder.Clean;
  ...
  FStrBuilder.Add(Format(' and %.0n species, based on user preferences. ESL analyses were conducted in MEGA%d [{%s:%s}] which', [FLinker.NumGridRows*1.0, MAJOR_VERSION, POST_PROCESS_CITATION, megaCitation]));
