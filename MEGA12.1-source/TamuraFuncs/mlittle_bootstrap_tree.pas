...
type
  ...
  TLittleBootstrapsTimetree = class(TObject)
    ...
    public
      ...
      constructor CreateFromSessionFile(var aFile: File; sessionFileVersion: Integer; SessionUsesExtended: Boolean; numOtus: Integer; otuNames: TStringList);
...
constructor TLittleBootstrapsTimetree.CreateFromSessionFile(var aFile: File; sessionFileVersion: Integer; SessionUsesExtended: Boolean; numOtus: Integer; otuNames: TStringList);
var
  i: Integer = -1;
  aNumNodes: Integer = -1;
begin
  ...
  begin
    ...
    begin
      ...
      FData[i].LoadFromSessionFile(aFile, SessionUsesExtended);
