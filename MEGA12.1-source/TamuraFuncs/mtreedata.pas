...
type
  ...
  private
    ...
    function GetNetBootstrap(Index: Integer): Integer;
...
function TTreeData.GetNetBootstrap(Index: Integer): Integer;
begin
  Result := 0;
  if (index < 0) or (index >= 2*(NoOfOTUs-1)) then Exit;
  Result := FNetBootstrap[index];
end;
