  ...
  try
    try
      ...
      begin
        ...
        MinimizeCaptionWhitespace(caption);
...
begin
  try
    ...
    //{$IFDEF DEBUG}{$IFNDEF VISUAL_BUILD}
    //WriteTreeToNewickFile(reltimeTree, FOrigOtuNames, NextAvailableFilenameNV('_full_timetree.nwk'), msg);
    //WriteTreeToNewickFile(FUserTree, FOrigOtuNames, NextAvailableFilenameNV('_user_tree.nwk'), msg);
    //{$ENDIF}{$ENDIF}
