...
type
  ...
  TNodeTimeData = class(TObject)
    ...
    public
      ...
      procedure LoadFromSessionFile(var aFile: File; SessionUsesExtended: Boolean);
  end;
...
procedure TMultiSampleNodeTimeData.LoadFromSessionFile(var aFile: File; SessionUsesExtended: Boolean);
var
  NumChars: Integer = -1;
  Buffer: Array[0..32767] of AnsiChar;
  i: Integer = -1;
begin
  ...
  BlockReadExtendedType(aFile, FReltime, SessionUsesExtended);
  BlockReadExtendedType(aFile, FDivTime, SessionUsesExtended);
  BlockReadExtendedType(aFile, FReltimeUpperBound, SessionUsesExtended);
  BlockReadExtendedType(aFile, FReltimeLowerBound, SessionUsesExtended);
  BlockReadExtendedType(aFile, FDivtimeUpperBound, SessionUsesExtended);
  BlockReadExtendedType(aFile, FDivtimeLowerBound, SessionUsesExtended);
  BlockReadExtendedType(aFile, FStdDev, SessionUsesExtended);
...
procedure TNodeTimeData.LoadFromSessionFile(var aFile: File; SessionUsesExtended: Boolean);
var
  i: Integer = -1;
  buffer: array[0..65535] of AnsiChar;
  numChars: Integer = -1;
...
begin
  ...
  BlockReadExtendedType(aFile, aReltime, SessionUsesExtended);
  ReltimeCalculator.Add(aReltime);
  BlockReadExtendedType(aFile, aMinReltime, SessionUsesExtended);
  MinReltimeCalculator.Add(aMinRelTime);
  BlockReadExtendedType(aFile, aMaxReltime, SessionUsesExtended);
  MaxReltimeCalculator.Add(aMaxReltime);
  BlockReadExtendedType(aFile, aDivTime, SessionUsesExtended);
  DivtimeCalculator.Add(aDivTime);
  BlockReadExtendedType(aFile, aMinDivTime, SessionUsesExtended);
  MinDivtimeCalculator.Add(aMinDivTime);
  BlockReadExtendedType(aFile, aMaxDivTime, SessionUsesExtended);
  MaxDivtimeCalculator.Add(aMaxDivTime);
  BlockReadExtendedType(aFile, aStdErr, SessionUsesExtended);
