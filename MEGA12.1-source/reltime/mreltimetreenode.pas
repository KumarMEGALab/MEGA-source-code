...
type
  ...
  TRelTimeTreeNode = class(TObject)
    ...
    public
      ...
      procedure ReadFromFile(var aFile: File; SessionUsesExtended: Boolean);
...
begin
  ...
  IsOutgroupMember := source.IsOutgroupMember;
end;
...
procedure TRelTimeTreeNode.ReadFromFile(var aFile: File; SessionUsesExtended: Boolean);
begin
  BlockReadExtendedType(aFile, FBlen, SessionUsesExtended);
  BlockReadExtendedType(aFile, FRate, SessionUsesExtended);
  BlockReadExtendedType(aFile, FHeight, SessionUsesExtended);
  BlockReadExtendedType(aFile, Fvb, SessionUsesExtended);
  BlockReadExtendedType(aFile, Fvr, SessionUsesExtended);
  BlockReadExtendedType(aFile, Fmaxh, SessionUsesExtended);
  BlockReadExtendedType(aFile, Fminh, SessionUsesExtended);
  BlockReadExtendedType(aFile, Fh0, SessionUsesExtended);
  BlockReadExtendedType(aFile, Fha0, SessionUsesExtended);
  BlockReadExtendedType(aFile, Fvh, SessionUsesExtended);
  BlockReadExtendedType(aFile, Fvh0, SessionUsesExtended);
  BlockReadExtendedType(aFile, Fvh1, SessionUsesExtended);
  BlockReadExtendedType(aFile, Fvh2, SessionUsesExtended);
  BlockReadExtendedType(aFile, Frtd0, SessionUsesExtended);
  BlockReadExtendedType(aFile, Frtd1, SessionUsesExtended);
  BlockReadExtendedType(aFile, FTime, SessionUsesExtended);
  BlockRead(aFile, FDataCoverage, SizeOf(Double));
  BlockReadExtendedType(aFile, h1, SessionUsesExtended);
  BlockReadExtendedType(aFile, h2, SessionUsesExtended);
