...
const
  { browser logs}
  renderProcessLog = 'Private' + PathDelim + 'logs' + PathDelim + 'renderer_process.log';
  browserProcessLog = 'Private' + PathDelim + 'logs' + PathDelim + 'browser_process.log';
  cefMainLog = 'Private' + PathDelim + 'logs' + PathDelim + 'cef_main_process.log';
  ...
  {$IFDEF DARWIN}
  mfTemplateConstants        = 'Private' + PathDelim + 'Citations' + PathDelim + 'MTemplateConstants.ini';
  {$ELSE}
  ...
  mfEditorMruFiles           = 'Private' + PathDelim + 'Ini' + PathDelim + 'EditorMruFiles.txt';
  mfTreeEditorMruFiles       = 'Private' + PathDelim + 'Ini' + PathDelim + 'TreeEditorMruFiles.txt';
  mfAlignmentExplorerFiles   = 'Private' + PathDelim + 'Ini' + PathDelim + 'AlignmentExplorerMruFiles.txt';
  mfBrowserCacheFile         = 'Private' + PathDelim + 'browser' + PathDelim + 'cef4_browser_cache';
  mfBrowserLogFile           = 'Private' + PathDelim + 'browser' + PathDelim + 'cef4_browser.log';
  ...
  { Session Files }
  sfClustalOptions = 'Private' + PathDelim + 'Ini' + PathDelim + 'ClustalSession.ini';
  ...
  NewickRecoveryFile = 'Private' + PathDelim + 'TreeEditor' + PathDelim + 'recoveryFile.nwk';

  sfOriTreeBox = 'Private' + PathDelim + 'Ini' + PathDelim + 'sfOriTreeBox.json';
  sfBootTreeBox = 'Private' + PathDelim + 'Ini' + PathDelim + 'sfBootTreeBox.json';
  sfReltimeTreeBox = 'Private' + PathDelim + 'Ini' + PathDelim + 'sfReltimeTreeBox.json';
  sfCustomTimeTreeBox = 'Private' + PathDelim + 'Ini' + PathDelim + 'sfCustomTimeTreeBox.json';
