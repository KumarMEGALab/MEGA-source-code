...
type
  ...
  public
    ...
    function HasProcessTypeInSet(AProcessTypeSet: TProcessTypesSet): Boolean;
...
function TProcessPack.HasProcessTypeInSet(AProcessTypeSet: TProcessTypesSet): Boolean;
var
  i: Integer;
  aType: TProcessType;
begin
  ...
  begin
    aType := ProcessTypes[i];
    if aType in AProcessTypeSet then
    begin
      Result := True;
      Exit;
    end;
...
begin
  ...
  try
    ...
    begin
      ...
      begin
        WriteLn('session test failed: ' + E.Message);
...
begin
  Result := (HasProcessTypeInSet(ProcessTypesThatRequireSequenceAlignment)) and (D_InputSeqData <> nil);
end;
