...
begin
  case UsrOperation of
    ...
    dtdoAvgDiversityWithinSubPops, dtdoWithinGroupMean: SetLength(MyMeanGpD, MAI.MyNoOfGps);
  ...
  if MAI.MyDistPack.VarType <> gdNone then
    case UsrOperation of
      ...
      dtdoAvgDiversityWithinSubPops, dtdoWithinGroupMean: SetLength(MyMeanGpV, MAI.MyNoOfGps);
...
begin
  ...
  begin
    ...
    case UsrOperation of
      ...
      dtdoAvgDiversityWithinSubPops, dtdoWithinGroupMean: MeanGpD := MyMeanGpD;
    ...
    if MAI.MyDistPack.VarType <> gdNone then
      case UsrOperation of
        ...
        dtdoWithinGroupMean, dtdoAvgDiversityWithinSubPops: MeanGpV := MyMeanGpV;
...
begin
  try
    ...
    D_MegaMain.AnalysisSummary.AddCalculatedValue('Dist Compute End Time', DateTimeToStr(DistComputer.EndTime));
