...
begin
  ...
  case UsrOperation of
    dtdoOverallMean, dtdoAvgDiversityWithinSubPops, dtdoAvgDiversityForEntirePop, dtdoInterPopDiversity, dtdoPropOfInterPopDiversity, dtdoWithinGroupMean:
    begin
      Result.SaveExcelFileTo := NextAvailableFilenameNV('.txt');
    end;
    else
      Result.SaveExcelFileTo := NextAvailableFilenameNV('.meg');
  end;
...
begin
  ...
  begin
      ...
      dtdoAvgDiversityWithinSubPops, dtdoWithinGroupMean:
        begin
  ...
  begin
    ...
    begin
      ...
      case UsrOperation of
        ...
        dtdoWithinGroupMean : DispDlgV.Caption := VER_MEGA_WIN_CAPTION_PREFIX+ ': Within Group Mean Distance';
...
begin
  ...
  case UsrOperation of
    dtdoOverallMean, dtdoAvgDiversityForEntirePop, dtdoInterPopDiversity, dtdoPropOfInterPopDiversity:
    begin
