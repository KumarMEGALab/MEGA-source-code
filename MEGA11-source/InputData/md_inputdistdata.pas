...
TD_InputDistdata = class
  ...
  Public
    ...
    function GetTaxaUsed(Index: Integer): Boolean;
...
Function TD_InputDistData.WritePairwiseData(ExportOptions: TDistExportOptions; FDistMat : PDistanceMatrix; RowNames : TStringList): TStringList;
var
...
function TD_InputDistData.GetDistance(i,j: LongInt): Double;
var
  xI, xJ: LongInt;
begin
...
function TD_InputDistData.CellContent(ARow, ACol: LongInt; var InvalidNum: Boolean): Double;
begin
...
procedure TD_InputDistData.PrepareDataForAnalysis(ADistMat: PDistanceMatrix; MyUsedOtuInfos: TList; NTaxa: LongInt);
var
  i, j, xJ: Integer;
...
function TD_InputDistData.GetAvgGps(MyComputeType: TDistType):TResultsWindowSetupOptions;
var
...
function  TD_InputDistData.GetGpName(Index: LongInt): AnsiString;
begin
  Index := DispTaxaList[Index];
  if Index < 0 then  Result := ''
...
function TD_InputDistData.WriteColumnarData(ExportOptions: TDistExportOptions; FDistMat : PDistanceMatrix; RowNames : TStringList): TStringList;
var
  OutList   : TStringList = nil;
  DispStr: String;
  xD, xS, X, Y: Integer;
