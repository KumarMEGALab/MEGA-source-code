...
type
  ...
  TTaxaGpsDlg = class(TForm)
    ...
    Buttons: TImageList;
    DeleteGroupBtn: TImage;
    ExportGroupsBtn: TImage;
    HelpButton: TImage;
    Image1: TImage;
    IniPropStorage1: TIniPropStorage;
    Label1: TLabel;
    SaveButton: TImage;
    ImportGroupsBtn: TImage;
    GroupSourcePage: TTabSheet;
    UngroupBtn: TImage;
    NewGroupBtn: TImage;
    SmallButtons: TImageList;
    SaveBtn: TImage;
    HelpBtn: TImage;
    ...
    procedure DeleteGroupBtnMouseEnter(Sender: TObject);
    procedure DeleteGroupBtnMouseLeave(Sender: TObject);
    procedure EditNameActionExecute(Sender: TObject);
    procedure ExportGroupsActionExecute(Sender: TObject);
    procedure ExportGroupsBtnMouseEnter(Sender: TObject);
    procedure ExportGroupsBtnMouseLeave(Sender: TObject);
    ...
    procedure ImportGroupsBtnMouseEnter(Sender: TObject);
    procedure ImportGroupsBtnMouseLeave(Sender: TObject);
    ...
    procedure NewGroupBtnMouseEnter(Sender: TObject);
    procedure NewGroupBtnMouseLeave(Sender: TObject);
    ...
    procedure UngroupBtnMouseEnter(Sender: TObject);
    procedure UngroupBtnMouseLeave(Sender: TObject);
  private
...
uses
  ContextHelp_HC, MEditorForm,
  MegaUtils, MPleaseWait, MegaVerConsts, MVS_SeqDataExplorer, mgeographical_info,
...
procedure TTaxaGpsDlg.DeleteGroupBtnMouseEnter(Sender: TObject);
begin
  SmallButtons.GetBitmap(5, DeleteGroupBtn.Picture.Bitmap);
end;

procedure TTaxaGpsDlg.DeleteGroupBtnMouseLeave(Sender: TObject);
begin
  SmallButtons.GetBitmap(4, DeleteGroupBtn.Picture.Bitmap);
end;
...
procedure TTaxaGpsDlg.ExportGroupsBtnMouseEnter(Sender: TObject);
begin
  SmallButtons.GetBitmap(11, ExportGroupsBtn.Picture.Bitmap);
end;

procedure TTaxaGpsDlg.ExportGroupsBtnMouseLeave(Sender: TObject);
begin
  SmallButtons.GetBitmap(10, ExportGroupsBtn.Picture.Bitmap);
end;
...
procedure TTaxaGpsDlg.Image1MouseEnter(Sender: TObject);
begin
  Buttons.GetBitmap(1, Image1.Picture.Bitmap);
end;

procedure TTaxaGpsDlg.Image1MouseLeave(Sender: TObject);
begin
  Buttons.GetBitmap(0, Image1.Picture.Bitmap);
end;

procedure TTaxaGpsDlg.InitImages;
begin
  {$IFDEF DARWIN}
    SaveButton.Proportional := True;
    HelpButton.Proportional := True;
    SaveBtn.Proportional:=True;
    HelpBtn.Proportional:=True;
    ExportGroupsBtn.Proportional:=True;
    ImportGroupsBtn.Proportional:=True;
    UngroupBtn.Proportional:=True;
    DeleteGroupBtn.Proportional:=True;
    NewGroupBtn.Proportional:=True;
  {$ENDIF}
end;
...
procedure TTaxaGpsDlg.HelpBtnMouseEnter(Sender: TObject);
begin
  SmallButtons.GetBitmap(1, HelpBtn.Picture.Bitmap);
end;

procedure TTaxaGpsDlg.HelpBtnMouseLeave(Sender: TObject);
begin
  SmallButtons.GetBitmap(0, HelpBtn.Picture.Bitmap)
end;

procedure TTaxaGpsDlg.HelpButtonMouseEnter(Sender: TObject);
begin
  SmallButtons.GetBitmap(1, HelpButton.Picture.Bitmap);
end;

procedure TTaxaGpsDlg.HelpButtonMouseLeave(Sender: TObject);
begin
  SmallButtons.GetBitmap(0, HelpButton.Picture.Bitmap);
end;
...
procedure TTaxaGpsDlg.ImportGroupsBtnMouseEnter(Sender: TObject);
begin
  SmallButtons.GetBitmap(9, ImportGroupsBtn.Picture.Bitmap);
end;

procedure TTaxaGpsDlg.ImportGroupsBtnMouseLeave(Sender: TObject);
begin
  SmallButtons.GetBitmap(8, ImportGroupsBtn.Picture.Bitmap);
end;
...
procedure TTaxaGpsDlg.NewGroupBtnMouseEnter(Sender: TObject);
begin
  SmallButtons.GetBitmap(3, NewGroupBtn.Picture.Bitmap);
end;

procedure TTaxaGpsDlg.NewGroupBtnMouseLeave(Sender: TObject);
begin
  SmallButtons.GetBitmap(2, NewGroupBtn.Picture.Bitmap);
end;
...
procedure TTaxaGpsDlg.SaveBtnMouseEnter(Sender: TObject);
begin
  Buttons.GetBitmap(1, SaveBtn.Picture.Bitmap);
end;

procedure TTaxaGpsDlg.SaveBtnMouseLeave(Sender: TObject);
begin
  Buttons.GetBitmap(0, SaveBtn.Picture.Bitmap);
end;

procedure TTaxaGpsDlg.SaveButtonMouseEnter(Sender: TObject);
begin
  Buttons.GetBitmap(1, SaveButton.Picture.Bitmap);
end;

procedure TTaxaGpsDlg.SaveButtonMouseLeave(Sender: TObject);
begin
  Buttons.GetBitmap(0, SaveButton.Picture.Bitmap);
end;
...
procedure TTaxaGpsDlg.UngroupBtnMouseEnter(Sender: TObject);
begin
  SmallButtons.GetBitmap(7, UngroupBtn.Picture.Bitmap);
end;

procedure TTaxaGpsDlg.UngroupBtnMouseLeave(Sender: TObject);
begin
  SmallButtons.GetBitmap(6, UngroupBtn.Picture.Bitmap);
end;
...
begin
  ...
  repeat
    ...
    NewString :=  'Gp '+IntToStr(TempSuffixGpInt);
