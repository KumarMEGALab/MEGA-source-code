...
uses
  ...
  StdCtrls, Buttons, CheckLst, Spin, MegaConsts, ExcelWrite, MD_InputSeqData,
  MEditorForm, mimageform;
...
uses
  ...
  mdefine_genetic_code_dlg, MWriteOutputDlg;
...
procedure TSelectGeneticCodeDlg.InitImages;
begin
  {$IFDEF DARWIN}
...
procedure TSelectGeneticCodeDlg.CancelBtnMouseEnter(Sender: TObject);
begin
  Buttons.GetBitmap(3, CancelBtn.Picture.Bitmap);
end;

procedure TSelectGeneticCodeDlg.CancelBtnMouseLeave(Sender: TObject);
begin
...
procedure TSelectGeneticCodeDlg.HelpBtnMouseEnter(Sender: TObject);
begin
  HelpButtons.GetBitmap(1, HelpBtn.Picture.Bitmap);
end;

procedure TSelectGeneticCodeDlg.HelpBtnMouseLeave(Sender: TObject);
begin
  HelpButtons.GetBitmap(0, HelpBtn.Picture.Bitmap);
end;
...
procedure TSelectGeneticCodeDlg.OkBtnMouseEnter(Sender: TObject);
begin
  Buttons.GetBitmap(1, OkBtn.Picture.Bitmap);
end;

procedure TSelectGeneticCodeDlg.OkBtnMouseLeave(Sender: TObject);
begin
