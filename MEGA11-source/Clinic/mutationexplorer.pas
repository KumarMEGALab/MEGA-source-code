...
begin
  case aCol of
    ...
    2: Result := 'Peptide ID';
    3: Result := 'mRNA ID';
    4: Result := 'Reference (AA)';
    5: Result := 'Mutant (AA)';
    6: Result := 'Consensus';
    7: Result := 'EvoD';
    8: Result := 'EvoD P-value';
    9: Result := 'Polyphen-2 Original';
    10: Result := 'Polyphen-2 Balanced';
    11: Result := 'SIFT Original';
    12: Result := 'SIFT Balanced';
    13: Result := 'EvoD';
    14: Result := 'Polyphen-2';
    15: Result := 'SIFT';
    16: Result := 'Grantham Distance';
    17: Result := 'Blosum 62';
    else
      Result := EmptyStr;
  end;
...
begin
  ...
  case aCol of
    ...
    4: Result := Format('%s', [diagnosis.Wildallele]);
    5: Result := Format('%s', [diagnosis.Mutantallele]);
    6: Result := Format('%s', [diagnosis.Conspred]);
    7: Result := Format('%s', [diagnosis.Evodpred]);
    8:
      begin
    ...
    9: Result := Format('%s', [diagnosis.Polyphenpred]);
    10: Result := Format('%s', [diagnosis.Polyphenpred_Balanced]);
    11: Result := Format('%s', [diagnosis.Siftpred]);
    12: Result := Format('%s', [diagnosis.Siftpred_Balanced]);
    13:
      begin
...
begin
  ...
  PredictionsDrawGrid.RowCount := 1;
  PredictionsDrawGrid.ColCount := 18;
