...
uses
  TextEditorHelp_HC, MegaVerConsts, mhelpfiles, mhelpkeywords;
...
begin
  ...
  //  DefaultInputType := gm_None;
  // help context has to come here
...
procedure TFormatConvertOptDlg.CancelBtnMouseEnter(Sender: TObject);
begin
  Buttons.GetBitmap(3, CancelBtn.Picture.Bitmap);
end;

procedure TFormatConvertOptDlg.CancelBtnMouseLeave(Sender: TObject);
begin
...
procedure TFormatConvertOptDlg.HelpBtnMouseEnter(Sender: TObject);
begin
  HelpButtons.GetBitmap(1, HelpBtn.Picture.Bitmap);
end;

procedure TFormatConvertOptDlg.HelpBtnMouseLeave(Sender: TObject);
begin
...
procedure TFormatConvertOptDlg.SaveBtnMouseEnter(Sender: TObject);
begin
  Buttons.GetBitmap(1, SaveBtn.Picture.Bitmap);
end;

procedure TFormatConvertOptDlg.SaveBtnMouseLeave(Sender: TObject);
begin
