...
const
  ...
  TREE_OPTIONS_RECT_BRANCH_LENGTH = 'tree_options_rect_branch_length';
  ...
  TREE_OPTIONS_RECT_BRANCH_LENGTH_INDEX = 1;
  TREE_OPTIONS_RECT_WIDTH_INDEX = 2;
  TREE_OPTIONS_TREE_TAXON_NAME_CIRCLE_INDEX = 3;
  TREE_OPTIONS_CIRCLE_START_ANGLE_INDEX = 4;
  TREE_OPTIONS_CIRCLE_RADIUS_INDEX = 5;
  TREE_OPTIONS_CIRCLE_CENTER_HOLE_INDEX = 6;
  TREE_OPTIONS_TREE_TAXON_NAME_RAD_INDEX = 7;
  TREE_OPTIONS_RAD_BRANCH_LENGTH_INDEX = 8;
  TREE_OPTIONS_RAD_START_ANGLE_INDEX = 9;
