...
type
  TProcessType = (ppNone,
                 ...
                 ppNewickOut, ppNewickIn, ppCalibrationConstraints, ppTaxaGroups, ppOutputName, ppSiteCoverage, ppModelSelIQTree);
  ...
  private
    ...
    FWorkflowElement: TWorkflowElement;
  ...
  public
    ...
    function MLBLensFilter: Extended;
    constructor Create;
    ...
    property WorkflowElement: TWorkflowElement read FWorkflowElement write FWorkflowElement;
end;
...
uses
  ...
  Graphics, Controls, Forms, Dialogs, Menus, ExtCtrls, ComCtrls, Buttons, StdCtrls,
...
begin
  ...
  ppEpML: Result := 'evolutionary_probability';
...
begin
  Result := [ppMLClock, ppRelTimeBLens, ppRelTimeLS, ppRelTimeML, ppAncSeq,
             ...
             ppRtdtLs, ppRtdtMl, ppTreeExplorer];
end;
...
function ProcessTypesThatUseCalibrations: TProcessTypesSet;
begin
  Result := [ppRelTimeML, ppRelTimeBLens, ppRelTimeLS, ppRtdtMl, ppRtdtLs, ppRtdtBlens];
end;

function ProcessTypesThatProduceSequenceAlignment: TProcessTypesSet;
begin
  Result := [ppAlign, ppProfileAlignment, ppClustalW, ppMuscle, ppMegaAlignment, ppFastaAlignment];
end;
...
begin
  Result := [ppInfer, ppNJ, ppME, ppUPGMA, ppMP, ppMLIQTree, ppRelTimeML, ppRelTimeBLens,
             ...
             ppRtdtMl, ppRtdtLs, ppRtdtBlens, ppNewickIn];
end;
...
begin
  ...
  FWorkflowElement := Source.WorkflowElement;
  AvailableIndex := 0;
...
begin
  ...
  Case ProcessTypes[0] of
    ...
    ppDistEst:
     ...
     ppBEAM: ProcessSeqMLBEAMCommand(dtdoBEAM, Self);
     ppAlign:
       begin
         AlignSequences(self);
       end;
...
begin
  Result := HasSetting(settingName) and (TextualSettingsList.Values[settingName] = settingValue);
end;
...
function TProcessPack.MLBLensFilter: Extended;
var
  filterSetting: AnsiString;
begin
  Result := -1;
  if TextualSettingsList.IndexOfName(opsBLensFilter2) <> -1 then
  begin
    filterSetting := TextualSettingsList.Values[opsBLensFilter2];
