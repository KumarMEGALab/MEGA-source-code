...
function TPartition.DescString: String;
var
  MyString: String;
begin
  MyString := '';

  MyString := MyString + '[Size] ' + IntToStr(Size) + #13#10;
  MyString := MyString + '[NoOfBits] ' + IntToStr(NoOfBits) + #13#10;
  MyString := MyString + '[Freq] ' + FloatToStrF(Freq, ffFixed, 5, 5) + #13#10;
  MyString := MyString + '[BLen] ' + FloatToStrF(BLen, ffFixed, 5, 5) + #13#10;
