...
type
  ...
  TAlignmentFileLoader = class(TObject)
    ...
    public
      ...
      function CloneSequenceList: TSequenceList;
...
begin
  ...
  if FShowProgress then
    ...
    FProgress := nil;
  FInputSeqData := TD_InputSeqData.CreateWithoutGui;
...
function TAlignmentFileLoader.CloneSequenceList: TSequenceList;
begin
