...
Unit Introduction_RH;
   Interface
   Const
	RH_Acknowledgements = 502;
	RH_System_Requirements = 503;
	RH_Installing_MEGA = 504;
	RH_Uninstalling_MEGA = 505;
	RH_Technical_Support = 506;
	RH_Reporting_Bugs = 507;
	RH_Guide_to_notation = 508;
	RH_Disclaimer = 509;
	RH_Using_MEGA_in_the_Classroom = 510;
	RH_Copyright = 511;
	Preface = 512;
	MEGA_Feature_List = 513;
	Whats_New_in_Version_3_0 = 514;
	MEGA_Software_Development_Team = 515;
	Implementation
	end.
