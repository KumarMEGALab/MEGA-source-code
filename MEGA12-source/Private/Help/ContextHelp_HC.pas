...
Unit ContextHelp_HC;
   ...
   Const
	...
	Molecular_Clock_Test_ML_ = 3059;
	Compute_MCL_Substitution_Matrix = 3060;
	Compute_MCL_Transversion_Transition_bias = 3061;
	Analyze_User_Tree_by_Least_Squares = 3062;
	Conduct_Interior_Branch_Test_by_Least_Squares = 3063;
	Get_Data_from_Saved_Session = 3064;
	Open_A_File = 3065;
	HC_Open_A_File = 3073;
	HC_Save_Data_Session_To_File = 3074;
	HC_Get_Data_from_Saved_Session = 3075;
	HC_Molecular_Clock_Test_ML_ = 3076;
	HC_Compute_MCL_Substitution_Matrix = 3077;
	HC_Compute_MCL_Transversion_Transition_bias = 3078;
	HC_Analyze_User_Tree_by_Least_Squares = 3079;
	HC_Conduct_Interior_Branch_Test_by_Least_Squares = 3080;
	Maximum_Likelihood_ML_ = 3081;
	HC_Maximum_Likelihood_ML_ = 3082;
	HC_Inferring_Ancestral_Sequences_ML_ = 3083;
	HC_Inferring_Ancestral_Sequences_MP_ = 3084;
	HC_Find_Best_DNA_Protein_Models_ML_ = 3085;
	HC_Estimate_Substitution_Matrix_ML_ = 3086;
	HC_Estimate_Transition_Transversion_Bias_ML_ = 3087;
	HC_Estimate_Rate_Variation_among_Sites_ML_ = 3088;
	HC_Analyze_User_Tree_by_Maximum_Likelihood = 3089;
	HC_Analyze_User_Tree_by_Parsimony = 3090;
	HC_Estimate_Position_by_Position_Rates_ML_ = 3091;
	HC_Estimate_Selection_for_each_Codon_HyPhy_ = 3092;
