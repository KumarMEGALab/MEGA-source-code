...
type
  ...
  TTreeInfoForm = class(TForm)
    ...
    Panel1: TPanel;
    TreeViewer: TCustomForm;
    procedure TreeViewerBtnClick(Sender: TObject);
...
procedure TTreeInfoForm.TreeViewerBtnClick(Sender: TObject);
begin
  if Assigned(TreeViewer) then
    TreeViewer.BringToFront
  else
    ShowMessage('Tree Viewer for this information box not found');
end;
