...
begin
  Result := 'The null hypothesis of independently varying rates among lineages in the provided phylogeny ';
  case FPvalue of
...
destructor TCorrelationTest.Destroy;
begin
  FSiblings := nil;
  FDirectDescendents := nil;
  FSecondDescendents := nil;
  FThirdDescendents := nil;
  inherited Destroy;
end;
