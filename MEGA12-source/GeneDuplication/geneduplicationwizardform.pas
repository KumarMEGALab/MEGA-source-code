...
uses
  MProcessPack, ContextHelp_HC, mhelpfiles, mhelpkeywords, math, MegaConsts, MegaVerConsts;
    ...
    case FProcessStep of
      gdpsLoadGeneTree:
        begin
          ...
          GetDefaultButtons.GetBitmap(0, LoadGeneTreeBtn.Picture.Bitmap);
        end;
      gdpsLoadSpeciesTree:
        begin
          ...
          GetDefaultButtons.GetBitmap(0, LoadSpeciesTreeBtn.Picture.Bitmap);
          GetSkipButtons.GetBitmap(0, SkipSpTreeBtn.Picture.Bitmap);
        end;
      gdpsMapSpecies:
        begin
          MapSpeciesNamesLabel.Font.Color := FCurrentStepFontColor;
          MapSpeciesAction.Enabled := True;
          GetDefaultButtons.GetBitmap(1, MapSpeciesNamesBtn.Picture.Bitmap);
        end;
      gdpsRootGeneTree:
        begin
          ...
          GetDefaultButtons.GetBitmap(2, RootGeneTreeBtn.Picture.Bitmap);
          GetSkipButtons.GetBitmap(0, SkipRootGeneTreeBtn.Picture.Bitmap);
        end;
      gdpsRootSpeciesTree:
        begin
          ...
          GetDefaultButtons.GetBitmap(2, RootSpeciesTreeBtn.Picture.Bitmap);
          GetSkipButtons.GetBitmap(0, SkipRootSpTreeBtn.Picture.Bitmap);
        end;
      gdpsLaunchAnalysis:
        begin
          InferGeneDupsAction.Enabled := True;
          GetDefaultButtons.GetBitmap(3, LaunchAnalysisBtn.Picture.Bitmap);
        end;
    end;
    Invalidate;
  finally
...
begin
  ...
  GetSkipButtons.GetBitmap(1, aImage.Picture.Bitmap);
end;
...
begin
  ...
  if not aImage.Enabled then
    Exit;
  GetSkipButtons.GetBitmap(0, aImage.Picture.Bitmap);
end;
...
begin
  ...
  Caption := VER_MEGA_WIN_CAPTION_PREFIX + ': Gene Duplications';
end;
...
begin
  if RootGeneTreeAction.Enabled then
    GetHoverButtons.GetBitmap(2, RootGeneTreeBtn.Picture.Bitmap);
end;
...
begin
  if RootSpeciesTreeAction.Enabled then
    GetHoverButtons.GetBitmap(2, RootSpeciesTreeBtn.Picture.Bitmap);
end;
...
begin
  if LoadSpeciesTreeAction.Enabled then
    GetHoverButtons.GetBitmap(0, LoadSpeciesTreeBtn.Picture.Bitmap);
end;
...
begin
  if MapSpeciesAction.Enabled then
    GetHoverButtons.GetBitmap(1, MapSpeciesNameSBtn.Picture.Bitmap);
end;
...
begin
  try
    BeginFormUpdate;
    GetDefaultButtons.GetBitmap(0, LoadGeneTreeBtn.Picture.Bitmap);
    GetDisabledButtons.GetBitmap(1, MapSpeciesNamesBtn.Picture.Bitmap);
    GetDisabledButtons.GetBitmap(0, LoadSpeciesTreeBtn.Picture.Bitmap);
    GetDisabledButtons.GetBitmap(2, RootGeneTreeBtn.Picture.Bitmap);
    GetDisabledButtons.GetBitmap(2, RootSpeciesTreeBtn.Picture.Bitmap);
    GetDisabledButtons.GetBitmap(3, LaunchAnalysisBtn.Picture.Bitmap);
    GetSkipButtons.GetBitmap(2, SkipRootGeneTreeBtn.Picture.Bitmap);
    GetSkipButtons.GetBitmap(2, SkipRootSpTreeBtn.Picture.Bitmap);
    GetSkipButtons.GetBitmap(2, SkipSpTreeBtn.Picture.Bitmap);
    GetHelpButtons.GetBitmap(0, Step1Img.Picture.Bitmap);
    GetHelpButtons.GetBitmap(0, Step2Img.Picture.Bitmap);
    GetHelpButtons.GetBitmap(0, Step3Img.Picture.Bitmap);
    GetHelpButtons.GetBitmap(0, Step4Img.Picture.Bitmap);
    GetHelpButtons.GetBitmap(0, Step5Img.Picture.Bitmap);
    Invalidate;
  finally
    EndFormUpdate;
  end;
...
begin
  if InferGeneDupsAction.Enabled then
    GetHoverButtons.GetBitmap(3, LaunchAnalysisBtn.Picture.Bitmap);
end;
...
begin
  if LoadGeneTreeAction.Enabled then
    GetHoverButtons.GetBitmap(0, LoadGeneTreeBtn.Picture.Bitmap);
end;
...
procedure TGDWizardForm.FormShow(Sender: TObject);
begin
  InitImages;
end;
...
procedure TGDWizardForm.FormClose(Sender: TObject; var CloseAction: TCloseAction);
begin
  CloseAction := caFree;
end;
...
function TGDWizardForm.GetDefaultButtons: TImageList;
var
...
function TGDWizardForm.GetDisabledButtons: TImageList;
var
  scaleFactor: Double = -1;
begin
  scaleFactor := PixelsPerInch/DesignTimePPI;
...
function TGDWizardForm.GetHoverButtons: TImageList;
var
  scaleFactor: Double = -1;
begin
  scaleFactor := PixelsPerInch/DesignTimePPI;
...
function TGDWizardForm.GetSkipButtons: TImageList;
var
  scaleFactor: Double = -1;
begin
  scaleFactor := PixelsPerInch/DesignTimePPI;
...
function TGDWizardForm.GetHelpButtons: TImageList;
var
  scaleFactor: Double = -1;
begin
  scaleFactor := PixelsPerInch/DesignTimePPI;
