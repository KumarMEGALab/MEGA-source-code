...
uses
  ...
  ExtCtrls, Buttons, StdCtrls, IniPropStorage, ActnList, MDomainInfo,
  msitepickform, MegaPrivateFiles, MegaUtils;
...
uses
  MD_InputSeqData, ContextHelp_HC, mhelpfiles, mhelpkeywords, mimageform;
...
procedure TGenesDomainsPropertiesEditor.FormActivate(Sender: TObject);
begin
...
procedure TGenesDomainsPropertiesEditor.FormResize(Sender: TObject);
begin
  if ClientWidth > ToolBar1.Width then
    ToolBar1.Left := Round((ClientWidth - ToolBar1.Width)/2);
end;
