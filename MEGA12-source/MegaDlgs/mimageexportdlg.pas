...
uses
  ...
  StdCtrls, Buttons, ActnList, IniPropStorage, ComCtrls, MegaConsts;
...
uses
  LazFileUtils, mshortcutshelper, mimageform;
...
procedure TImageExportForm.FormResize(Sender: TObject);
begin
...
procedure TImageExportForm.CancelActionExecute(Sender: TObject);
begin
...
procedure TImageExportForm.FormActivate(Sender: TObject);
begin
