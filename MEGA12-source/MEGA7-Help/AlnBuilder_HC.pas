...
Interface
  ...
  //function AlnBuilderHelpContextToKeyword(HC: Integer): String;
...
Implementation
  ...
  //    HC_Toolbars_in_Alignment_Explorer: Result := '';
  ...
  //    HC_Sequencer_Menu_in_Alignment_Explorer: Result := '';
  ...
  //    HC_CLUSTALW_Options_DNA_Dialog: Result := '';
  //    HC_CLUSTALW_Options_Protein_Dialog: Result := '';
  //    Aligning_coding_sequences_via_protein_sequences: Result := '';
  //    HC_Web_Browser: Result := '';
  //    HC_About_BLAST: Result := '';
  //    HC_CLUSTALW: Result := '';
  //    HC_Trace_Data_File_Viewer_Editor: Result := '';
  //    About_MUSCLE: Result := '';
  //    MUSCLE_Options_DNA_: Result := '';
  //    MUSCLE_Options_Protein_: Result := '';
  //    Mafft: Result := '';
  //  end;
  //end;
