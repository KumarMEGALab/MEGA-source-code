...
begin
  try try
    ...
    begin
      ...
      MAI.MyIncludedSites := D_InputSeqData.PrepareDataForDistAnalysis(MAI.MySubsetOpt, MAI.MyMappedData, MyThreeOtuInfos, MAI.MyNoOfSeqs, MAI.MyNoOfSites, MAI.MyLabelsUsed, MAI.RecodeScheme, MAI.SiteCoverage);
