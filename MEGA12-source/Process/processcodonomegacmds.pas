...
uses
  ...
  MegaUtils, MegaErrUtils, StringUtils, fphttpclient, openssl, opensslsockets,
  {$IFDEF VISUAL_BUILD}
  Mega_Main, MWriteOutputDlg,
  {$ELSE}
  MD_MegaMain, mseqexportoptions,
  {$ENDIF}
  KeywordConsts, MNucDist, MD_InputSeqData, MRuntimeProgressDlg, StrUtils, Menus;
